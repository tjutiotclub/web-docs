...
完成以上内容后，你将具备使用常见基础外设搭建简单 STM32 项目的能力。

后续还需要继续学习程序架构、控制理论、实时系统和具体应用领域知识。状态机与系统结构更偏向软件设计，PID 控制则需要相应的控制理论基础。

---

## 阶段性目标与实践落点

完成 STM32 基础外设的学习后，你可以开始把多个外设组合成一个可运行的小型项目。
...
欢迎走进实验室，通过接线、调试和测试把文档中的知识用于实际项目。
